...
/*默认颜色，RGB565与RGB888通用接口*/
#define LCD_COLOR_WHITE_ARGB8888          0xA0FFFFFF
#define LCD_COLOR_BLACK_ARGB8888          0x40000000
#define LCD_COLOR_GREEN_ARGB8888          0xFF00FF00
#define TRANSPARENCY_ARGB8888             0x00000000
...
void LCD_SetColors_ARGB8888(uint32_t TextColor, uint32_t BackColor);
void LCD_DrawLine_ARGB8888(uint16_t Xpos, uint16_t Ypos, uint16_t Length,uint8_t Line_width ,uint8_t Direction);
void LCD_View_Finder_ARGB8888(uint16_t Width,uint16_t Length,uint16_t size ,uint32_t color);
