...
/* TIM从模式的从模式PWM输出引脚 */
#define GENERAL_SLAVE11_PIN           GPIO_Pin_12             
#define GENERAL_SLAVE11_GPIO_PORT     GPIOD                      
#define GENERAL_SLAVE11_GPIO_CLK      RCC_AHB1Periph_GPIOD
#define GENERAL_SLAVE11_PINSOURCE			GPIO_PinSource12
