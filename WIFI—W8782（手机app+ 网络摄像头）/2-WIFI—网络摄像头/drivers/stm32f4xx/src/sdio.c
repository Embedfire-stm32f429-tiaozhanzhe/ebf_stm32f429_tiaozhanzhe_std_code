...
#define SDIO_INIT_CLK_DIV               ((uint8_t)0xf0)

//#define SDIO_INT_USE_GPIO
...
static void GPIO_Configuration(void)
{
	...
	RCC_AHB1PeriphClockCmd(RCC_AHB1Periph_GPIOC|RCC_AHB1Periph_GPIOH | RCC_AHB1Periph_GPIOD, ENABLE);
